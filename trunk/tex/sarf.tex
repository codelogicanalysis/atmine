...
may have two valid morphological analyses. In the first
the letter \RL{'a} is a prefix and the word means ``I praise him'',
and in the second the letter \RL{'a} is part of the stem 
...
Beesely~\shortcite{Beesley:01}, SAMA~\cite{Kulick:10},
...
of proper names in the text, and ignores most of the analyses 
where we do not have proper names in text as long 
as they are valid.
