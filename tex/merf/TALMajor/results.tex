...
\textit{Musnad Ahmad}, a hadith book, where we constructed an annotated 
golden reference containing 1,865 words.
We evaluated ATEEMA 
with articles from issues of  the Lebanese 
\textit{Al-Akhbar} newspaper where we constructed 
...
Finally, we used an annotated article from the Lebanese \textit{Assafir}
