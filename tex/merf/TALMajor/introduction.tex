...
The figure also presents a transliteration and an English translation of the Arabic text.
...
zero or one, zero or more, one or more, up to $M\in\mathbb{N}^+$, and logical conjunction and disjunction.
