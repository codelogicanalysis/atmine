/**
  ...
  */
#ifndef SUFFIX_SEARCH_H
#define SUFFIX_SEARCH_H
...
class SuffixSearch : public TreeSearch {
    public:
        ...
        bool isPrefixStemSuffixCompatible() const {//check rules AC, BC
            ...
            return ((*cr)(prefix_category, resulting_category_idOFCurrentMatch)) &&
                   ((*cr)(stem_category, resulting_category_idOFCurrentMatch));
        }
