...
class AbstractTwoLevelAgreement {
    ...
    protected:
        ...
        void overLapMainFinished(int tagNum, int outputNum, const SelectionList &tagNames, const SelectionList &outputNames,
                                 int &numNames);
        void overLapNamesFinished(const SelectionList &tagNames, const SelectionList &outputNames, int &numWords);
    public:
        AbstractTwoLevelAgreement(QString *text, QString fileName, AbstractGraph *generatedGraph,
                                  OutputDataList &generatedTags);
...
template <class T>
int commonNames(QString *text, const AbstractTwoLevelAgreement::SelectionList &list1,
                const AbstractTwoLevelAgreement::SelectionList &list2, QSet<int> &visitedTags, int &allCommon, T &t) {
