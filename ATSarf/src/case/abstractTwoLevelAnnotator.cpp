...
AbstractTwoLevelAnnotator::AbstractTwoLevelAnnotator(QString file_name, QString main_structure, QString an_ext) :
    QMainWindow(),
    filename(file_name),
    ext(an_ext),
...
bool AbstractTwoLevelAnnotator::save_action() {
    ...
    if (file.open(QIODevice::WriteOnly)) {
        ...
        _error << "Unexpected Error: Unable to open file\n";
        return false;
    }
}
