...
extern int segmentNarrators(QString *text, int (*functionUsingChains)(ChainsContainer &, ATMProgressIFC *, QString),
                            ATMProgressIFC *prg);
extern int segmentNarrators(QString *text, int start, int end, int (*functionUsingChains)(ChainsContainer &,
                            ATMProgressIFC *, QString), ATMProgressIFC *prg);
...
class NameConnectorPrim : public NarratorPrim {
    ...
    public:
        ...
        void setFamilyConnector() {
            if (type != IBN && type != OM && type != AB) {
                type = FAMILY_OTHER;
            }
        }
        bool isFamilyConnector() {
            return type == IBN || type == OM || type == AB || type == FAMILY_OTHER;
        }
        void setOther() {
            type = OTHER;
        }
...
class Biography {
    ...
    public:
        ...
        virtual ~Biography() { //TODO: check there are no memory leaks
