...
//TODO: solve issue of abstract not read correctly
void compatibility_rules::fill() {
    ...
    QVector<QString> columns(4);
    columns[0] = "category_id1";
    columns[1] = "category_id2";
    columns[2] = "resulting_category";
    columns[3] = "type";
    Retrieve_Template order("compatibility_rules", columns, "");
    size = order.size();
    i = 0;
