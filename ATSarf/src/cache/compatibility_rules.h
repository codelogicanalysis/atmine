...
class compatibility_rules {
    private:
        ...
        class NameIsAbstract {
            ...
            public:
                ...
                NameIsAbstract() : abstract(false), valid(false) {}
        };
    ...
    public:
        ...
        bool operator()(int id1, int id2, long &id_r) {
            //-1 is invalid
            try {
        ...
        int getAbstractCategoryID(const QString &name) {
            //-1 is invalid, -2 not abstract
            CatName2CatIDMap::iterator i = catNamesMap.find(name);
