...
class result_node: public node {
    ...
    public:
        ...
        result_node(long affix_id, long previous_category_id, long resulting_category_id, bool isAccept, QString raw_data,
                    QString inflected): node() {
