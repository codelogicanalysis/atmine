...
int bit_PROC3, bit_PROC2, bit_PROC1, bit_PROC0, bit_DET, bit_ENC0, bit_CASE;
int * morpheme_bits[morpheme_bits_size]= {&bit_PROC3, &bit_PROC2, &bit_PROC1, &bit_PROC0, &bit_DET, &bit_ENC0, &bit_CASE};
